...
$O365CustomerName      = "lifuli"          #This should be the name of your tenant (example, lieben as in lieben.onmicrosoft.com) 
...
$autoRemapMethod       = "Path"                    #automatically rerun if a connection is dropped / lost but an active internet connect exists. Options: "Path" (checks underlying webdav connection), "Link" (checks existence of driveletter or shortcut as well, only works for drivemappings and converged drives), "Disabled" (no reruns)
